...
!
! program history log:
!   20201129  li      - modified for sst_vrfy utility
!
!   input argument list:
!
...
! Declare parameters
  integer, parameter:: n_comps = 3
  integer, parameter:: n_scripps = 40
  integer, parameter:: n_triton = 70
  integer, parameter:: n_3mdiscus = 153
  integer, parameter:: lunship = 11
  integer, save     :: n_ship = 2011
...
!
   ...
   write(6,*) ' in read_ship_info, n_ship = ', n_ship
